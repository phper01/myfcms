...
class Authnum {
	...
	function set_bgcolor() {
		...
		$borderColor = imagecolorallocate($this->im, 100, 100, 100);   
		 @imagerectangle($this->im, 0, 0, $this->im_width - 1, $this->im_height - 1, $borderColor); 
	}
	// 获得任意位数的随机码
	function get_randnum() {
		...
		$_SESSION["myf_vcode"] = $this->randnum;
	}
	// 获得验证码图片Y轴
	function get_y() {
		if ($this->ext_rand_y)
