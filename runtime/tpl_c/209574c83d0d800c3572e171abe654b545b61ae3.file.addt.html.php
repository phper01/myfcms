<?php /* Smarty version Smarty-3.1.11, created on 2018-05-14 10:49:02
         compiled from "E:\wamp\www\myfcms\admin\tpl\moban\addt.html" */ ?>
<?php /*%%SmartyHeaderCode:6627350895af8f91e021f92-03593342%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '209574c83d0d800c3572e171abe654b545b61ae3' => 
    array (
      0 => 'E:\\wamp\\www\\myfcms\\admin\\tpl\\moban\\addt.html',
      1 => 1358779049,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6627350895af8f91e021f92-03593342',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5af8f91e05a285_98278489',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5af8f91e05a285_98278489')) {function content_5af8f91e05a285_98278489($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<title>新建主题-闵益飞内容管理系统</title>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#submit-btn").click(function(){
					...
					if(author==""){
						$("#infoAuthor").addClass("red");
						isOk=false;
					}else{
						$("#infoAuthor").removeClass("red");
					}
					
					var web = $.trim($("#txtWeb").val());
					if(web==""){
						$("#infoWeb").addClass("red");
						isOk=false;
					}else{
...
/index.php?m=moban&a=theme_add_handler" method="post">
						<table id="tab0" class="tabindex">
							<tbody>
								<tr>
									<td class="taright" width="100"><span class="tred">*</span>主题英文名：</td>
									<td class="taleft">
										<input class="left mr10 fm-text" style="margin-top: 0;width:350px;" id="txtTheme" name="theme" type="text" size="15" value="<?php echo $_smarty_tpl->tpl_vars['mb']->value['theme'];?>
">
